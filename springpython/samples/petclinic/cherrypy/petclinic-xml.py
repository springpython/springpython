...
if __name__ == '__main__':
    ...
    cherrypy.tree.mount(applicationContext.get_object(componentId = "root"), '/', config=conf)
    cherrypy.tree.mount(applicationContext.get_object(componentId = "loginForm"), '/login', config=login_conf)
