...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns="http://www.w3.org/TR/xhtml1/transitional" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="#default">
...
<!--###################################################
    ...
    <xsl:template name="toc.line">
        ...
        <fo:block end-indent="{$toc.indent.width}pt" last-line-end-indent="-{$toc.indent.width}pt" white-space-treatment="ignore" linefeed-treatment="ignore" text-align-last="justify" white-space-collapse="true">
            <fo:inline keep-with-next.within-line="always">
                ...
                <fo:basic-link internal-destination="{$id}">
                    <xsl:if test="$label != ''">
                        ...
                        <fo:inline white-space-treatment="ignore" linefeed-treatment="ignore" white-space-collapse="true">
