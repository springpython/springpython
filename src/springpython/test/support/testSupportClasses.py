...
class BeforeAndAfterInterceptor(MethodInterceptor):
    def __init__(self):
        self.logger = logging.getLogger("springpython.test.testSupportClasses.BeforeAndAfterInterceptor")
...
class WrappingInterceptor(MethodInterceptor):
    def __init__(self):
        self.logger = logging.getLogger("springpython.test.testSupportClasses.WrappingInterceptor")
...
class Bank(object):
    ...
    def __init__(self, factory):
        self.logger = logging.getLogger("springpython.test.testSupportClasses.Bank")
...
class TransactionalBank(object):
    ...
    allow the from-account to leak assets."""
    def __init__(self, factory):
        self.logger = logging.getLogger("springpython.test.testSupportClasses.TransactionalBank")
        self.dt = DatabaseTemplate(factory)
...
class TransactionalBankWithNoTransactionalArguments(object):
    ...
    allow the from-account to leak assets."""
    def __init__(self, factory):
        self.logger = logging.getLogger("springpython.test.testSupportClasses.TransactionalBankWithNoTransactionalArguments")
        self.dt = DatabaseTemplate(factory)
