...
from springpython.test.support.testSupportClasses import DatabaseTxTestAppContext
from springpython.test.support.testSupportClasses import DatabaseTxTestDecorativeTransactions
from springpython.test.support.testSupportClasses import DatabaseTxTestDecorativeTransactionsWithNoArguments
from springpython.test.support.testSupportClasses import DatabaseTxTestDecorativeTransactionsWithLotsOfArguments
from springpython.test.support.testSupportClasses import DatabaseTxTestAppContextWithNoAutoTransactionalComponent
from springpython.test.support.testSupportClasses import BankException
from springpython.test.support.testSupportClasses import TransactionalBank
...
class AbstractTransactionTestCase(unittest.TestCase):
    ...
    def testDecoratorBasedTransactionsWithLotsOfArguments(self):
        ...
        self.assertEquals(bank.balance("Savings"), 225.00, "Bad transfer did NOT fail atomically!")
        logging.getLogger("springpython.test.databaseTransactionTestCases").debug(bank.balance("Checking"))
        self.assertEquals(bank.balance("Checking"), 140.00, "Bad transfer did NOT fail atomically!")
